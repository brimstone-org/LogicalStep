...
namespace Localization
{
    ...
    public class LanguageManager : MonoBehaviour
    {
        ...
        public void PopulateFlags(Transform[] flags)
        {
            Flags.Clear();
        ...
        public bool CheckIfThisIsCurrentLanguage(string tag)
        {
            if (tag == languageTags[Language])
            {
                return true;
            }
            return false;
        ...
        public static Font GetFont()
        {
            ...
            {
                if (Instance.specialFonts[i].languages.Contains(Instance.Language))
